...
Collection = (_temp = _class = function () {
    ...
    function Collection() {var items = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];(0, _classCallCheck3.default)(this, Collection);this.models = [];
    ...
    _prepare = function _prepare(items, Model) {var _this = this;
        items.forEach(function (item) {
            item._id = (0, _helpers.generateGuid)();
