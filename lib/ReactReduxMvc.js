...
var _propTypes = require('prop-types');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var
...
ReactReduxMvc = (_temp = _class = function (_Component) {(0, _inherits3.default)(ReactReduxMvc, _Component);ReactReduxMvc.prototype.
    ...
    };return ReactReduxMvc;}(_react.Component), _class.propTypes = { children: _propTypes.element.isRequired, store: _propTypes.object.isRequired }, _class.childContextTypes = { store: _propTypes.object.isRequired }, _temp);exports.default = ReactReduxMvc;module.exports = exports['default'];